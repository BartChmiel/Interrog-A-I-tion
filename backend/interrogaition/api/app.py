...
def create_app(
    ...
    def generate_workspace_grounded_suggestions(
        ...
        audit_details = {
            ...
            "support_state": result.support_report.state,
            "support_unknown_source_count": result.support_report.summary.get("unknown_sources", 0),
        ...
        return {
            ...
            "support_report": _to_jsonable(result.support_report),
