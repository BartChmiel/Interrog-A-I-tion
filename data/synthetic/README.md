...
| `case-003` | Care facility medication discrepancy | Role-boundary awareness, documentation grounding, medication timeline conflicts, inventory reconciliation, and cabinet-access contradiction. | Default supervisor demo and tutorial |
